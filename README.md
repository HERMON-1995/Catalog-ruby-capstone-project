...
```sh
  cd Catalog-ruby-capstone-project
  git clone https://github.com/HERMON-1995/Catalog-ruby-capstone-project.git
```
...
- Twitter: [Twitter](https://twitter.com/kelvin_ngotho)
...
Feel free to check the [issues page](https://github.com/HERMON-1995/Catalog-ruby-capstone-project/issues).
